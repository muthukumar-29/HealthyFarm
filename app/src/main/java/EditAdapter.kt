...
class EditAdapter(private val productList: ArrayList<ProductEdit>) : RecyclerView.Adapter<EditAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.edit_products,
            parent,false)
